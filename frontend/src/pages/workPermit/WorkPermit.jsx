    ...
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            Personal protective equipment must be provided and appropriate for
            the task.
          </li>
        </ul>
      </div>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.inlineParagraph}>
            ...
            <input
              ...
              placeholder="Place"
            />
            . The sector intervention has summer delimited, the ways of traffic
            of the people and equipment indicated.
          </p>
        </div>
        <div className={styles.gridTwoCol_2}>
